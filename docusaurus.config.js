...
var config = {
        ...
        [
            "classic",
            {
                docs: {
                    ...
                    editUrl: function (_a) {
                        var docPath = _a.docPath;
                        return "https://github.com/recodehive/recode-website/tree/main/docs/".concat(docPath);
                    },
                },
                blog: {
    ...
    themeConfig: {
        ...
        footer: {
            style: "dark",
            links: [],
            copyright: "Copyright \u00A9 ".concat(new Date().getFullYear(), " recodehive. Built with Docusaurus."),
        },
        prism: {
