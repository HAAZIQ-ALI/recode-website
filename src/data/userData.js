...
exports.Users = [
    ...
    {
        title: "ML Repository",
        description: "Curated collection of machine learning projects, tutorials, and resources for enthusiasts and developers.",
    ...
    //  Opesource project
    {
        ...
        description: "A beginner-friendly repository designed for newcomers to  learn , collaborate and practice open-source contributions.",
    ...
    {
        title: "Scrape ML",
        description: "Scrape ML is a Streamlit app that allows users to scrape and analyze data from various websites, providing insights and visualizations for machine learning enthusiasts.",
    ...
    // StackOverflow Analysis
    {
        ...
        description: "StackOverflow Analysis is a comprehensive data analysis project that explores the vast repository of questions and answers on StackOverflow. ",
    ...
    // Awesome GitHub Profiles"
    {
        ...
        description: "Curated list of awesome GitHub profiles showcasing creativity, design, and coding skills.",
