...
var getYoutubeVideoId = function (url) {
    var videoId = '';
    var normalMatch = url.match(/(?:youtube\.com\/watch\?v=|youtu\.be\/)([^&\s]+)/);
    var shortsMatch = url.match(/youtube\.com\/shorts\/([^&\s]+)/);
    if (normalMatch) {
...
function VideoDetails() {
    ...
    var video = state === null || state === void 0 ? void 0 : state.video;
    var _a = (0, react_1.useState)('Loading...'), title = _a[0], setTitle = _a[1];
    (0, react_1.useEffect)(function () {
        var fetchVideoTitle = function () { return __awaiter(_this, void 0, void 0, function () {
            var response, data, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(video === null || video === void 0 ? void 0 : video.youtubeUrl))
                            return [2 /*return*/];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
        ...
        fetchVideoTitle();
    }, [video === null || video === void 0 ? void 0 : video.youtubeUrl]);
