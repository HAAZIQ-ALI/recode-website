...
exports.default = ScrollTopToBottom;
...
function ScrollTopToBottom() {
    ...
    var handleScroll = function () {
        var bottomThreshold = document.documentElement.scrollHeight - window.innerHeight - 100;
